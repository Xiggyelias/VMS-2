...
define('APP_DESCRIPTION', 'AU Vehicle Registration and Management System');
...
// URL Configuration
define('BASE_URL', 'http://localhost/system/frontend');
define('ASSETS_URL', BASE_URL . '/assets');

// Session Configuration
define('SESSION_NAME', 'vehicle_registration_session');
...
define('SMTP_FROM_EMAIL', 'noreply@au.ac.zw');
define('SMTP_FROM_NAME', 'AU Vehicle Registration System');

// Vehicle Registration Settings
define('MAX_VEHICLES_PER_STUDENT', 1);
define('MAX_VEHICLES_PER_STAFF', 5);
define('MAX_VEHICLES_PER_GUEST', 3);
define('VEHICLE_REGISTRATION_EXPIRY_DAYS', 365);
