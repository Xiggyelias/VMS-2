    ...
    <main class="hero">
        <div class="container">
            <div class="hero-card">
                ...
                <p>Fast, secure, and convenient vehicle registration for students, staff, and guests. Manage vehicles and authorized drivers in one place.</p>
                <div class="hero-ctas">
                ...
                <section class="how">
                    ...
                    <div class="steps">
                        <div class="step">
                            ...
                            <p>Choose your role (student, staff, guest) and register your account.</p>
                        </div>
                        <div class="step">
                            <div class="num">2</div>
